...
export default function School() {
    ...
    const navArr = [
        ...
        {link: '/school/students', component: 'Students', icon: EmojiPeopleIcon},
        {link: '/school/teachers', component: 'Teachers', icon: PeopleIcon},
        {link: '/school/schedule', component: 'Schedule', icon: EventNoteIcon},
        {link: '/school/attendance', component: 'Attendance', icon: FingerprintIcon},
